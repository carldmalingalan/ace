            ...
            <div class="modal-dialog body" role="document">
                ...
                <div class="modal-content">
                    ...
                    <b>Middle Name</b>
                        <div class="form-group form-float">
                            <div class="form-line">
                                <input type="text" class="form-control focused" name="m_name" id="m_name">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <b>Role</b>
                        <select class="form-control show-tick" name="role_name" title="Please select a role" id="role_id" required>
