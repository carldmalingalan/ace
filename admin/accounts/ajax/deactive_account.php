...
$complete_query="SELECT * FROM users A JOIN acc_status B ON A.is_activated = B.status_id WHERE A.is_activated = 2 AND A.is_deleted = 0";    
...
$recordsFiltered = $con->myQuery("SELECT * FROM users WHERE is_activated = 2 AND is_deleted = 0")->rowCount();
