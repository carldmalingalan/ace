<?php
	...
	$columns = array(
                array('db' => 'room_type_id', 'dt' => ++$index),
                array(
                    'db' => 'room_name', 
                    'dt' => ++$index,
...
$complete_query="SELECT * FROM room_type WHERE is_deleted = 0";    
...
$recordsFiltered = $con->myQuery("SELECT * FROM room_type WHERE is_deleted = 0")->rowCount();
