...
<?php
	...
	$columns = array(
        		...
        		'formatter' => function( $d, $row ) 
                {
                    ...
                    // $action_buttons .= "<button type='button' class='btn m-l-5 m-t-5 btn-circle bg-red waves-float waves-circle waves-effect' onclick='archiveInfo({$d})'><i class='material-icons'>archive</i></button>";
                    // }
